      ...
      <div className="flex flex-row justify-space-between gap-3">
        <aside className="w-64 bg-gray-300 dark:bg-gray-900 min-h-full flex flex-col items-center pt-5 pb-2 space-y-7">
          <div>
            ...
            <div className="mt-5 flex flex-col items-center space-x-2">
              <img
          ...
          {/* <!-- menu items --> */}
          <div className="mt-20 w-full flex items-center gap-x-1.5 group select-none">
            ...
            <div
              className=" text-gray-300 group-hover:bg-gray-200 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm"
              href="#">
              <svg
          ...
          <div className="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
            <div className="pl-4 text-gray-500 text-xs text-[11px] uppercase">Menu</div>
            ...
            <div className="w-full flex items-center gap-x-1.5 group select-none">
              ...
              <div
                className="group-hover:bg-gray-200 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-white text-sm"
                href="#">
                <svg
          ...
          {/* <!-- menu items --> */}
          <div className="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
            <div className="pl-4 text-gray-500 text-xs text-[11px] uppercase">Profile</div>
        ...
        <div className="flex-1 flex flex-col mr-4 bg-gray-400 dark:bg-gray-900">
          ...
          <div className="px-67 mt-3 border border-red-700 w-min-full h-min-full">
            <div className="flex flex-col">
              <div className="flex flex-row gap-2 border border-red-900 mb-3 justify-between">
                <div className="border border-red-900 gap-2 mx-2 bg-gray-400">
                  <p>Where is it?</p>
                </div>
                <div className="border border-red-900 gap-2 mx-2 bg-gray-400">
                  <p>Where is it?</p>
              ...
              <div className="flex flex-row border border-red-900 gap-2 mb-3 justify-between">
                <div className="border border-red-900 gap-2 mx-2 bg-gray-400">
                  <p>Where is it?</p>
                </div>
                <div className="border border-red-900 gap-2 mx-2 bg-gray-400">
