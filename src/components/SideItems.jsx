...
const SideItems = () => {
  return (
    <>
      {/* <!-- component --> */}
      <aside class="w-64 bg-gray-100 dark:bg-gray-900 min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7">
        <div>
          <div>
            <a href="https://flowbite.com" class="flex items-center">
              <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
              <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Event-App</span>
            </a>
          </div>
        ...
        {/* <!-- menu items --> */}
        <div class="mt-20 w-full flex items-center gap-x-1.5 group select-none">
        ...
        <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
          <div class="pl-4 text-gray-500 text-xs text-[11px] uppercase">Menu</div>
        ...
        {/* <!-- menu items --> */}
        <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
          <div class="font-QuicksandMedium pl-4 text-gray-500 text-xs text-[11px] uppercase">Profile</div>
