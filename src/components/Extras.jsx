      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div class="mx-0 max-w-screen-sm text-left mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">More Events</h2>
          </div>
          <div class="grid gap-8 sm:grid-cols-3 lg:grid-cols-4">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
              <div class="relative pb-48 overflow-hidden">
                <img class="absolute inset-0 h-full w-full object-cover" src="/src/assets/images/event-2.jpg" alt="" />
              </div>
              <div class="float-right text-gray-900 mt-[-2px] p-2 mr-3 ml-1 rounded-full border">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
              <div class="relative pb-48 overflow-hidden">
                <img class="absolute inset-0 h-full w-full object-cover" src="/src/assets/images/event-5.jpg" alt="" />
              </div>
              <div class="float-right text-gray-900 mt-[-2px] p-2 mr-3 ml-1 rounded-full border">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
              <div class="relative pb-48 overflow-hidden">
                <img class="absolute inset-0 h-full w-full object-cover" src="/src/assets/images/event-3.jpg" alt="" />
              </div>
              <div class="float-right text-gray-900 mt-[-2px] p-2 mr-3 ml-1 rounded-full border">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
              <div class="relative pb-48 overflow-hidden">
                <img class="absolute inset-0 h-full w-full object-cover" src="/src/assets/images/event-6.jpg" alt="" />
              </div>
              <div class="float-right text-gray-900 mt-[-2px] p-2 mr-3 ml-1 rounded-full border">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
              <div class="relative pb-48 overflow-hidden">
                <img class="absolute inset-0 h-full w-full object-cover" src="/src/assets/images/event-7.jpg" alt="" />
              </div>
              <div class="float-right text-gray-900 mt-[-2px] p-2 mr-3 ml-1 rounded-full border">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
