...
const TopItems = () => {
  return (
    <>
      ...
      <div className="bg-black border-b border-red-700 ml- py-10 min-w-full w-screen">
        <p>This is the area for the nav when completed</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start">
                ...
                <a href="#" className="text-xl font-bold flex items-center lg:ml-2.5">
                  <img src="https://demo.themesberg.com/windster/images/logo.svg" className="h-6 mr-2" alt="Windster Logo"></img>
